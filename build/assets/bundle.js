/******/ (() => {
  ...
  \******************************************/
      /***/ () => {
        ...
        if (accordeons) {
          ...
          accordeons.forEach((accordeon) => {
            const expanders = accordeon.querySelectorAll(
    ...
    /***/ "./src/scripts/modules/catalogTileCardSquares.js":
      /*!*******************************************************!*\
  !*** ./src/scripts/modules/catalogTileCardSquares.js ***!
  \*******************************************************/
      /***/ () => {
        const containers = document.querySelectorAll(
          ".catalog-tile-card__header"
        );
        if (containers) {
          const COUNT = 3;
    ...
    /***/ "./src/scripts/modules/introSectionSquares.js":
      /*!****************************************************!*\
  !*** ./src/scripts/modules/introSectionSquares.js ***!
  \****************************************************/
      /***/ () => {
  ...
  \*****************************************/
      /***/ () => {
        ...
        if (nav) {
          ...
          const nestedNavItem = nav.querySelector(
            ".main-nav__list-item-nested"
          );
          ...
          const fillNavItems = () => {
            const navContainerWidth =
              navContainer.getBoundingClientRect().width;
  ...
  \*******************************************/
      /***/ (
        ...
        /* harmony import */ var _utils_functions__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
            /*! ../utils/functions */ "./src/scripts/utils/functions.js"
          );
        ...
        if (nav) {
          ...
          const closeNav = () => {
            (0, _utils_functions__WEBPACK_IMPORTED_MODULE_0__.bodyLocker)(
              false
            );
  ...
  \*********************************************/
      /***/ () => {
        var searchOpener = document.querySelector(".search-block-opener");

        if (searchOpener) {
          var searchBlock = document.querySelector(".search-block");
          var searchCloser = document.querySelector(".search-block-closer");

          var onClickToggleSearchBlock = function onClickToggleSearchBlock() {
  ...
  \***************************************/
      /***/ (
        ...
        if (reviewSlider) {
          const initialSlide =
            reviewSlider.querySelectorAll(".swiper-slide").length;
          const controls =
            reviewSlider.parentNode.querySelector(".swiper-controls");
          let prevEl = null;
          let nextEl = null;
          if (controls) {
    ...
    /***/ "./src/scripts/modules/template-common.js":
      /*!************************************************!*\
  !*** ./src/scripts/modules/template-common.js ***!
  \************************************************/
      /***/ () => {
  ...
  \****************************************/
      /***/ (
        ...
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          ...
          /* harmony export */ getBoundingClientRect: () =>
            /* binding */ getBoundingClientRect,
          /* harmony export */ getCssPropertyValue: () =>
            /* binding */ getCssPropertyValue,
          ...
          /* harmony export */ setVieportHeight: () =>
            /* binding */ setVieportHeight,
        ...
        function focusTrap(el) {
          ...
          const firstFocusableElement =
            el.querySelectorAll(focusableElements)[0];
  ...
  \*****************************/
    __webpack_require__.r(__webpack_exports__);
    /* harmony import */ var _modules_main_nav__WEBPACK_IMPORTED_MODULE_0__ =
      __webpack_require__(
        /*! ./modules/main-nav */ "./src/scripts/modules/main-nav.js"
      );
    /* harmony import */ var _modules_main_nav__WEBPACK_IMPORTED_MODULE_0___default =
      /*#__PURE__*/ __webpack_require__.n(
        _modules_main_nav__WEBPACK_IMPORTED_MODULE_0__
      );
    /* harmony import */ var _modules_search_field__WEBPACK_IMPORTED_MODULE_1__ =
      __webpack_require__(
        /*! ./modules/search-field */ "./src/scripts/modules/search-field.js"
      );
    /* harmony import */ var _modules_search_field__WEBPACK_IMPORTED_MODULE_1___default =
      /*#__PURE__*/ __webpack_require__.n(
        _modules_search_field__WEBPACK_IMPORTED_MODULE_1__
      );
    /* harmony import */ var _modules_mobile_nav__WEBPACK_IMPORTED_MODULE_2__ =
      __webpack_require__(
        /*! ./modules/mobile-nav */ "./src/scripts/modules/mobile-nav.js"
      );
    /* harmony import */ var _modules_introSectionSquares__WEBPACK_IMPORTED_MODULE_3__ =
      __webpack_require__(
        /*! ./modules/introSectionSquares */ "./src/scripts/modules/introSectionSquares.js"
      );
    /* harmony import */ var _modules_introSectionSquares__WEBPACK_IMPORTED_MODULE_3___default =
      /*#__PURE__*/ __webpack_require__.n(
        _modules_introSectionSquares__WEBPACK_IMPORTED_MODULE_3__
      );
    /* harmony import */ var _modules_swiper__WEBPACK_IMPORTED_MODULE_4__ =
      __webpack_require__(
        /*! ./modules/swiper */ "./src/scripts/modules/swiper.js"
      );
    /* harmony import */ var _modules_accordeon__WEBPACK_IMPORTED_MODULE_5__ =
      __webpack_require__(
        /*! ./modules/accordeon */ "./src/scripts/modules/accordeon.js"
      );
    /* harmony import */ var _modules_accordeon__WEBPACK_IMPORTED_MODULE_5___default =
      /*#__PURE__*/ __webpack_require__.n(
        _modules_accordeon__WEBPACK_IMPORTED_MODULE_5__
      );
    /* harmony import */ var _modules_template_common__WEBPACK_IMPORTED_MODULE_6__ =
      __webpack_require__(
        /*! ./modules/template-common */ "./src/scripts/modules/template-common.js"
      );
    /* harmony import */ var _modules_template_common__WEBPACK_IMPORTED_MODULE_6___default =
      /*#__PURE__*/ __webpack_require__.n(
        _modules_template_common__WEBPACK_IMPORTED_MODULE_6__
      );
  })();
